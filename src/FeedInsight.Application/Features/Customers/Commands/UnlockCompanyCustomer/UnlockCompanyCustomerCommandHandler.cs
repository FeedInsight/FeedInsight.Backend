...
{
    public class UnlockCompanyCustomerCommandHandler: IRequestHandler<UnlockCompanyCustomerCommand, ErrorOr<Success>>
    {
        private readonly IRepository<User> _userRepository;
        private readonly IUnitOfWork _unitOfWork;

        public UnlockCompanyCustomerCommandHandler(
        ...
        public async Task<ErrorOr<Success>> HandleAsync(
            UnlockCompanyCustomerCommand request,
